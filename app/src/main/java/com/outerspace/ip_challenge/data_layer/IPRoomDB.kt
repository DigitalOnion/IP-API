...
interface IPDao {
    ...
    suspend fun insertIP(pkIP: String?, status: String?,
                         country: String?, countryCode: String?, region: String?, regionName: String?,
                         city: String?, zip: String?, lat: Double?, lon: Double?,
                         timezone: String?, isp: String?, org: String?, autonomousSystem: String?)
